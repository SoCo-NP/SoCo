...
public class FileTreeManager {
    ...
    public FileTreeManager(Component parentFrame, CollabClient collab, TabManager tabManager) {
    ...
    public void openSelectedInEditor() {
        getSelectedFile().ifPresent(f -> { if (f.isFile()) tabManager.openFile(f); });
    }
    ...
    public void actionCreateFileOnDisk() {
        ...
        } catch (java.io.IOException e) { showError("파일 생성 오류: " + e.getMessage()); }
    }
